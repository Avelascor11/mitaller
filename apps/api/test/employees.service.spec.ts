          ...
          findMany: async () => [
            {
              ...
              contributions: [{ id: 'c-1', employeeId: 'emp-1', orderId: 'order-1', role: 'PREPARACION', units: 1, createdAt: new Date('2026-06-25T11:30:00Z'), order }]
            },
            {
              id: 'emp-2',
              name: 'Luis',
              ...
              contributions: [{ id: 'c-2', employeeId: 'emp-2', orderId: 'order-1', role: 'PACKING', units: 1, createdAt: new Date('2026-06-25T11:40:00Z'), order }]
            }
          ]
        }
      } as never,
